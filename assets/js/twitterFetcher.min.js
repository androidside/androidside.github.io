...
function handleTweets(tweets) {
    ...
    tweetsHtml = '<ul class="twitterFeed">';
    tweetsName = 	'<a  class"twitter-feed-name" href="https://twitter.com/jordivilahdl" target="_blank"> Jordi Vila ‎@jordivilahdl</a>';
    while(n < x) {
      tweetsHtml += '<li>' + tweetsName + tweets[n] + '</li>';
      n++;
    }
    tweetsHtml += '</ul>';

      tweetsHtml += '</ul>';
      $('#twitterFeed').html(element.innerHTML = tweetsHtml);
    //  $('#twitterFeed').html(element.innerHTML = "<img src=\'assets/img/logo/nasaLogo.png'\>" + tweetsHtml);
//      $('#twitterFeed').html(element.innerHTML =  "<img src="tweetsHtml.getElementById('img')"\>" );
    ...
    //element.innerHTML = tweetsHtml;
}
/*
handleTweets(tweets){
  var x = tweets.length,
    n = 0,
    tweetsHtml = '<ul class="twitterFeed">'; //<ul class="twitterFeed">  <li> Hola </li>
